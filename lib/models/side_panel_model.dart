...
import '../views/widgets/side_panel/single_marker/single_marker_side_panel_widget.dart';
import '../views/widgets/side_panel/multiple_marker/multiple_marker_side_panel_widget.dart';
...
class MultipleMarkerSidePanelModel extends SidePanelModel {
  ...
  @override
  Widget build(BuildContext context, {required bool isDesktop}) {
    return MultipleMarkerSidePanel(
      markers: markers,
      isDesktop: isDesktop,
      onMarkerSelected: (_) {},
    );
